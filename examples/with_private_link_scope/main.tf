...
module "network" {
  ...
  enable_monitor_private_link_scope            = var.enable_monitor_private_link_scope
  monitor_private_link_scope_subnet_name       = var.monitor_private_link_scope_subnet_name
